...
import AppNotFound from '../errorpage/AppNotFound'; //  added , pore lagbe
...
const AppDetails = () => {
        ...
        fetch('/appdata.json')
            ...
            .then(data => {
                ...
                if (foundApp) {
                    ...
                    setApp(null); // just null die update korlam
                }
                setIsLoading(false);
            })
            .catch(err => {
                ...
                setIsLoading(false);
                setApp(null); // handle error again
            });
    }, [id]);
    ...
    if (!app) {
        return <AppNotFound />; //  show not found page navigation chara
    }
